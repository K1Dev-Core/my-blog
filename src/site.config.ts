...
const config: SiteConfig = {
  ...
  tags: ['Hex', 'Blog', 'Hex Blog'],
  // Path to the image used for generating social media previews.
  // Needs to be a square JPEG file due to limitations of the social card generator.
  // Try https://squoosh.app/ to easily convert images to JPEG.
  socialCardAvatarImage: "public/images/avatar.png",
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/K1Dev-Core',
      external: true,
    },
  ],
  ...
  giscus: {
    repo: 'K1Dev-Core/blog.k1god.com',
    repoId: 'R_kgDOPNnBig',
    category: 'Giscus',
    categoryId: 'DIC_kwDOPNnBis4CteO',
